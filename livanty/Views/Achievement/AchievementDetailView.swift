...
struct AchievementDetailView: View {
    ...
    Text(skill)
      ...
      .background(
        Capsule()
          ...
          .overlay(
            Capsule()
              .stroke(achievement.color.opacity(0.6), lineWidth: 1)
          )
      )
  }
  ...
  func getRelatedSkills() -> [String] {
    ...
    case "Lead Vocalist":
      return ["Performance", "Vocal Range", "Composition", "Stage Presence"]
    case "Guitar Mastery":
      return ["Music Theory", "Fingerpicking", "Improvisation", "Rhythm"]
    case "Music Production":
      return ["Audio Engineering", "Composition", "Sound Design", "Mixing"]
